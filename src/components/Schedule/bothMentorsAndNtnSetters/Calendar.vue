      ...
      <v-sheet height="64">
        <v-toolbar flat color="white">
          <v-row>
            ...
            <v-col cols="12" sm="auto" class="text-sm-left">
            ...
            <v-col cols="12" sm="auto" class="text-sm-left">
              ...
              <v-toolbar-title class="d-inline">{{ title }}</v-toolbar-title>
              <!-- <div class="flex-grow-1">hi</div> -->
            </v-col>

            <!-- right section of toolbar -->
            <v-col cols="12" sm class="text-sm-right">
              <v-menu bottom right>
...
export default {
  ...
  methods: {
    async getEvents() {
      let snapshot = await db.collection("appts").get();
      const events = [];
